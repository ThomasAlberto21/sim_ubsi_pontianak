    <?php foreach ($record as $row) : ?>
        ...
        <section>
            <div class="container mb-5">
                ...
                <div class="image">
                    <!-- Parent Img -->
                    <img src="<?= base_url('/assets/images/kegiatan/' . $row['gambar']); ?>" class="img-fluid w-100 mt-2 mb-3 rounded-2" alt="kegiatan" />
                </div>
                <h3 class="mb-3"><?= $row['nama_kegiatan'] ?></h3>
                <!-- Author -->
