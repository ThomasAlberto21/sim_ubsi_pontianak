                        ...
                        <div class="col-lg-8">
                            <div class="card-body">
                                <h4 class="card-title mb-2">
                                    Sukses Di Kesempatan Pertama, Mahasiswa Universitas BSI
                                    Raih Prestasi Di Bidang Modeling
                                </h4>
                                ...
                                <a href="detailPrestasi.html" class="text-primary mt-5 px-0 align-items-center d-flex gap-2 text-decoration-none">
                                    Baca Selengkapnya
                ...
                <div class="card border-0 shadow mb-3">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card-body">
                                <h4 class="card-title mb-2">
                                    Lanjut Ke Tingkat Nasional, Mahasiswa Universitas BSI
                                    Sukses Raih Gelar Putra Putri Kampus Kalimantan Barat 2024
                                </h4>
                                <div class="d-flex align-items-center gap-4 opacity-50 mb-4">
                                    <iconify-icon icon="clarity:date-line"></iconify-icon>
                                    Senin , 07 Agustus 2023 , 08:30 WIB
                        ...
                        <div class="col-lg-8">
                            <div class="card-body">
                                ...
                                <p class="card-text opacity-75" style="text-align: justify">
                                    ...
                                    Pontianak. Ankreas 2022 ini dilaksanakan pada 3–4 Juni
                                    2022 yang berlokasi di auditorium Universitas Muhammadiyah
                                    Pontianak.....
                                </p>
